          ...
          <tbody>
            ...
            <tr>
              ...
              <a href="<?=base_url()?>company/edit?id=<?=$v['id']?>"><button class="button button-small button-warning">编辑</button></a>
               <a href="javascript:void(0);" onclick="flush('删除后不能恢复，确定删除吗?','<?=base_url()?>company/del?id=<?=$v['id']?>')"><button class="button button-small button-danger">删除</button></a>
              <a href="<?=base_url()?>account/index?company_id=<?=$v['id']?>"><button class="button button-small button-success">账号</button></a>
