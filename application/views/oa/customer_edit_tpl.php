  ...
  <div class="container">
    ...
    <div class="doc-content">
      ...
      <div class="control-group">
        ...
        <div class="controls">
          <input type="text" class="input-large" id="fax" name="fax" value="<?=$info['fax']?>">
        </div>
      </div>
            <div class="control-group">
        <label class="control-label">QQ：</label>
        <div class="controls">
          <input type="text" class="input-large" id="qq" name="qq" value="<?=$info['qq']?>">
        </div>
      </div>
      <div class="control-group">
        <label class="control-label">微信：</label>
        <div class="controls">
          <input type="text" class="input-large" id="webchat" name="webchat" value="<?=$info['webchat']?>">
        </div>
      </div>
      <div class="control-group">
