...
<div>
  ...
  <div style="text-align: left;">
	...
	<tr>
		<td><input id="txtw_sex_0" type="radio" name="txtw_sex" value="0" checked="checked" /><label for="txtw_sex_0">男</label></td><td><input id="txtw_sex_1" type="radio" name="txtw_sex" value="1" /><label for="txtw_sex_1">女</label></td>
	</tr>
</table>
        </td>
        <td height="25" align="right">
