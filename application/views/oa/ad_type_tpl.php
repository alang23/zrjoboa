        ...
        <table cellspacing="0" class="table table-bordered">
          <thead>
            ...
            <th colspan="15">
                ...
                <a href="<?=base_url()?>ad_type/add"><li class="bui-bar-item-button bui-bar-item bui-inline-block" aria-disabled="false" id="bar-item-button1" aria-pressed="false">
                <button type="button" class="button button-small" id="btnShow">
                <i class="icon-plus"></i>添加广告位</button>
                </li></a>
                </ul>
            </th>
            </tr>
